...
int j = 0;        //Count the number of interruptions of high frequency to start the motor
int n = 0;        //Number of iterations
int i = 0;        //Index of the motor commands
String p1 = ",";  //String variable to print variable to .csv file
...
void setup() {
  ...
  /*2. We set the prescalar to the desired value by changing the CS10 CS12 and CS12 bits. */  
  TCCR1B |= B00000100;        //Set CS12 to 1 so, CS11 to 0, and CS10 to 0 we get prescalar 256  
  ...
  //Serial.println("Trial Description: Squarewave - Both Directions");
...
void loop() {
   ...
   if (intboom == true){
    ...
    ddp = tensaoMedida2-tensaoMedida1;

    // Prints the measure values according to the Header
...
//With the settings above, this IRS will trigger each 1 s.
